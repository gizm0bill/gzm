import { ChangeDetectionStrategy, ChangeDetectorRef, Component, DoCheck, ElementRef, EventEmitter, HostBinding, Input, OnDestroy, OnInit, Optional, Output, Self, ViewChild } from '@angular/core';
import { MatFormFieldControl } from '@angular/material/form-field';
import { FormGroupDirective, NG_VALIDATORS, NgControl, NgForm } from '@angular/forms';
import { AsYouType, CountryCode as CC, E164Number, NationalNumber, PhoneNumber, getExampleNumber, parsePhoneNumberFromString, } from 'libphonenumber-js';
import { CountryCode, Examples } from './country-code';
import { Country } from './country.model';
import { PhoneNumberFormat } from './phone-number-format.model';
import { phoneNumberValidator } from './validator';
import { FocusMonitor } from '@angular/cdk/a11y';
import { coerceBooleanProperty } from '@angular/cdk/coercion';
import { CanUpdateErrorState, ErrorStateMatcher, _AbstractConstructor, _Constructor, mixinErrorState, } from '@angular/material/core';
...
export class MaterialPhoneInputComponent extends _NgxMatIntlTelInputMixinBase implements OnInit, OnDestroy, DoCheck, CanUpdateErrorState, MatFormFieldControl<any>
{
  ...
  focused = false;
  @HostBinding()
  id = `ngx-mat-intl-tel-input-${MaterialPhoneInputComponent.nextId++}`;
  ...
  protected fetchCountryData(): void {
    this.countryCodeData.allCountries.forEach( ( c ) => {
      ...
      if ( this.enablePlaceholder ) {
        country.placeHolder =
          MaterialPhoneInputComponent.getPhoneNumberPlaceHolder(
